...
class CanToolsDatabaseTest(unittest.TestCase):
    ...
    def test_system_arxml_traversal(self):
        ...
        with self.assertRaises(ValueError) as cm:
            no_base_elem = loader.find_arxml_children(None, ["AR-PACKAGES", "*AR-PACKAGE"])
        self.assertEqual(str(cm.exception), "Cannot retrieve a child element of a non-existing node!")

        # test multiple child node matches
        children1 = loader.find_arxml_children(loader.root, ["AR-PACKAGES", "*AR-PACKAGE"])
        ...
        with self.assertRaises(ValueError) as cm:
            non_unique = loader.find_arxml_children(loader.root, ["AR-PACKAGES", "AR-PACKAGE"])
        ...
        with self.assertRaises(ValueError) as cm:
            no_base_elem = loader.find_unique_arxml_child(loader.root, ["AR-PACKAGES", "*AR-PACKAGE"])

...
class CanToolsDatabaseTest(unittest.TestCase):
    ...
    def test_vehicle(self):
        ...
        self.assertEqual(repr(db.messages[0].signals[0]),
                         ...
                         "False, 0, 1, 0, 0, 1, 'None', False, None, None, None, {'EN': 'Valid when "
    ...
    def test_dbc_signal_initial_value(self):
        ...
        self.assertEqual(
            ...
            "None, 1, 0, None, None, 'None', False, None, None, None, {'EN': 'Valid when bit is "
        ...
        self.assertEqual(
            ...
            "0.001, 0, -65, 65, 'g', False, None, None, None, {'EN': 'Longitudinal "
    ...
    def test_foobar(self):
        ...
        self.assertEqual(
            ...
            "node('FUM', None)\n"
            "\n"
            "message('Foo', 0x12330, True, 8, {'EN': 'Foo.'})\n"
            ...
            "0, 0, 5, 'm', False, None, None, None, {'EN': 'Bar.'})\n"
            "\n"
    ...
    def test_special_chars_6_0_sym(self):
        ...
        self.assertEqual(signal_4.choices, None)
        self.assertEqual(signal_4.comments["EN"], 'ö')
    ...
    def test_system_3_arxml(self):
        ...
        self.assertEqual(signal_3.choices, {'STANDARD_POSITION': 0,
                                            'FORWARD_POSITION': 1,
                                            'BACKWARD_POSITION': 2})
        self.assertEqual(signal_3.comments, {})
        self.assertEqual(signal_3.is_multiplexer, False)
        self.assertEqual(signal_3.multiplexer_ids, None)
        ...
        self.assertEqual(signal_4.minimum, 0)
        self.assertEqual(signal_4.maximum, 3)
        self.assertEqual(signal_4.decimal.scale, 10.0/4)
        self.assertEqual(signal_4.decimal.offset, 40.0/4)
        self.assertEqual(signal_4.decimal.minimum, 0)
        self.assertEqual(signal_4.decimal.maximum, 3)
        self.assertEqual(signal_4.unit, None)
        self.assertEqual(signal_4.choices, None)
    ...
    def test_system_arxml_traversal(self):
        ...
        with self.assertRaises(ValueError) as cm:
            no_base_elem = loader._find_arxml_children(None, ["AR-PACKAGES", "*AR-PACKAGE"])
        self.assertEqual(str(cm.exception), "Cannot retrieve a child element of a non-existing node!")

        # test multiple child node matches
        children1 = loader._find_arxml_children(loader._root, ["AR-PACKAGES", "*AR-PACKAGE"])
        ...
        with self.assertRaises(ValueError) as cm:
            non_unique = loader._find_arxml_children(loader._root, ["AR-PACKAGES", "AR-PACKAGE"])
        ...
        with self.assertRaises(ValueError) as cm:
            no_base_elem = loader._find_unique_arxml_child(loader._root, ["AR-PACKAGES", "*AR-PACKAGE"])
